...
int main(){
    ...
    for (int i = 0; i < nb_simulation; ++i){
        double x1 = Loi(G); double x2 = Loi(G); double y1 = Loi(G); double y2 = Loi(G); double z1 = Loi(G); double z2 = Loi(G);
        X(0,1) = x1;
        X(0,2) = y1;
        X(1,2) = z1;
        Y(0,1) = x2;
    ...
    cout << "moyenne de x est " << s_x/(double)nb_simulation <<endl;
    cout << "moyenne de y est " << s_y/(double)nb_simulation <<endl;
	return 0;
